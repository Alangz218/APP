...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String url="https://tron.network/enindex.html";//地址
    private String url1="https://tron.network/enindex.html";//地址
    private String url2="https://tron.network/enabout.html";//地址
    private String url3="https://tron.network/entechnical.html";//地址
    ...
    private void postRequest(final String phone){
